...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function handleSend() {
        ...
        try {
            ...
            if (intent.mode === 'quiz') {
                try {
                    // Safe cleanup for markdown wrappers returned by the AI
    ...
    function appendMessage(sender, text, shouldSave = false) {
        ...
        const avatar = sender === 'user' ? '<i class="fa-solid fa-user"></i>' : '<i class="fa-solid fa-graduation-cap"></i>';
    ...
    function loadSpecificChat(id) {
        ...
        chat.messages.forEach(msg => { 
            if(msg.content !== "[Interactive Quiz Generated]") {
